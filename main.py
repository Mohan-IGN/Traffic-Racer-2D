...
# fonts
fontsize = pygame.font.SysFont(None, 25)
...
# images
player_car_photo = pygame.image.load('computer_car1.png')
computer_car3 = pygame.image.load('computer_car3.png')
computer_car4 = pygame.image.load('computer_car4.jpg')
gamer_Rect = player_car_photo.get_rect()
computer_car_photo = pygame.image.load('computer_car2.png')
another = [computer_car3, computer_car4, computer_car_photo]
w_left = pygame.image.load('left_side.png')
w_right = pygame.image.load('right_side.png')

# "welcome" screen
txt_objects('PRESS SPACEBAR TO START.', fontsize, screen_display_window, (screen_width / 3) - 30, (screen_height / 3))
txt_objects('LETS BEGIN THE RACE', fontsize, screen_display_window, (screen_width / 3), (screen_height / 3) + 30)
